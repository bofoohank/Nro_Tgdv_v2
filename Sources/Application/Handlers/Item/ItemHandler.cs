...
namespace NRO_Server.Application.Handlers.Item
{
    public class ItemHandler
    {
                                    ...
                                    if (player != null && player.Trade.CharacterId == character.Id)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (DataCache.IsIdItemNotTrade(itemTrade.Id) ||
                                                (!DataCache.TypeItemTrade.Contains(template.Type) &&
                                                !DataCache.ItemPremiumTrade.Contains(itemTrade.Id) &&
                                                !DataCache.ItemNormalTrade.Contains(itemTrade.Id)))
                                            {
                                                character.CharacterHandler.SendMessage(Service.Trade2(index));
                                                character.CharacterHandler.SendMessage(
        ...
        public static void UseItemBag(Model.Character.Character character, int index, short template = -1)
        {
            ...
            {
                Model.Item.Item itemUse;
                if (template != -1 && DataCache.IdDauThan.Contains(template))// dùng đậu
                {
                    itemUse = character.ItemBag.FirstOrDefault(item => item.Id == template);
                    if (itemUse != null) UsePea(character, itemUse, 0);
                    return;
                ...
                if (itemTemplate.Type == 11)
                {
                    ...
                    // character.Delay.SaveData += 1000;
                    character.InfoChar.pickDuaBe = false;
                    character.CharacterHandler.AddItemToBody(itemUse, 7);
                    ...
                    case 454:
                        {
                            ...
                            if (character.InfoChar.Fusion.IsFusion)
                            {
                                ...
                                if (character.InfoChar.Fusion.IsPorata3)
                                {
                                    character.CharacterHandler.SendMessage(Service.ServerMessage(TextServer.gI().PLEASE_USE_PORATA_3));
                                    return;
                                }
								if (character.InfoChar.Fusion.IsPorata4)
                                {
                                    character.CharacterHandler.SendMessage(Service.ServerMessage(TextServer.gI().PLEASE_USE_PORATA_4));
                                    return;
                                }
                    ...
                    case 1108:
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    character.InfoChar.Fusion.IsFusion = true;
                                    character.InfoChar.Fusion.IsPorata3 = true;
                                    character.InfoChar.Fusion.TimeStart = timeServer;
                                    character.InfoChar.Fusion.TimeUse = 600000;
                                }
                                disciple.Status = 4;
                    ...
                    case 1110:
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    character.InfoChar.Fusion.IsFusion = true;
                                    character.InfoChar.Fusion.IsPorata4 = true;
                                    character.InfoChar.Fusion.TimeStart = timeServer;
                                    character.InfoChar.Fusion.TimeUse = 600000;
                                }
                                disciple.Status = 4;
        ...
        private static void UseCapsuleKiBi(Model.Character.Character character, Model.Item.Item item)
        {
            ...
            //else if (randomPercent <= 70) // an danh
            //{
            ...
            else if (randomPercent <= 75) //giap xen
            {
            ...
            else if (randomPercent <= 80) //bo khi
            {
            ...
            else if (randomPercent <= 85) //bo huyet
            {
            ...
            else if (randomPercent <= 90) //cuong no
            {
            ...
            else if (randomPercent <= 95) //cải trang
            {
                ...
                var itemAdd = ItemCache.GetItemDefault(629);// frieza vàng
                itemAdd.Quantity = 1;
                itemAdd.Options.Clear();
                itemAdd.Options.Add(new OptionItem()
                {
                    Id = 93,
                    Param = expireDay,
                ...
                {
                    Id = 100,
                    Param = ServerUtils.RandomNumber(1, 100)
                });
                character.CharacterHandler.AddItemToBag(true, itemAdd, "CSKB");
                var template = ItemCache.ItemTemplate(itemAdd.Id);
                character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().CSKB_GET, template.Name)));
        ...
        private static void UseBuffItem(Model.Character.Character character, Model.Item.Item item)
        {
            switch (item.Id)
            {
                ...
                case 1100:
                    {
                        character.InfoBuff.CuongNoPro = true;
                        character.InfoBuff.CuongNoProTime = ServerUtils.CurrentTimeMillis() + 600000;
                        break;
                    }
                case 382:
                    {
                ...
                case 1107:
                    {
                        character.InfoBuff.ThuocHoiTrinh = true;
                        character.InfoBuff.ThuocHoiTrinhTime = ServerUtils.CurrentTimeMillis() + 600000;
                        break;
                    }
        ...
        private static void UseGiftBox(Model.Character.Character character, Model.Item.Item item)
        {
            ...
            character.CharacterHandler.RemoveItemBagByIndex(item.IndexUI, 1, reason: "Mở hộp quà");

            var randomPercen = ServerUtils.RandomNumber(0.0, 150.0);
            var itemGift = new Model.Item.Item();
            if (randomPercen < 0.1)// ct thỏ vv
            {
                var timeServer = ServerUtils.CurrentTimeSecond();
                itemGift = ItemCache.GetItemDefault((short)ServerUtils.RandomNumber(409, 411));
                itemGift.Options.Clear();
                itemGift.Options.Add(new OptionItem()
                {
                    Id = 147,
                    Param = (short)ServerUtils.RandomNumber(10, 40),
                });
                itemGift.Options.Add(new OptionItem()
                {
                    Id = 77,
                ...
                {
                    Id = 117,
                    Param = (short)ServerUtils.RandomNumber(5, 10),
                });
            }
            else if (randomPercen < 20.0)// đá ngũ sắc
            {
                itemGift = ItemCache.GetItemDefault(674);
            }
            else if (randomPercen < 30.0)// thỏi vàng
            {
                itemGift = ItemCache.GetItemDefault(457);
            }
            else if (randomPercen < 40.0)// đá bảo vệ
            {
                itemGift = ItemCache.GetItemDefault(987);
            }
            else if (randomPercen < 50.0)// ngọc rồng
            {
                itemGift = ItemCache.GetItemDefault((short)ServerUtils.RandomNumber(15, 20));
            }
            else if (randomPercen < 60.0)// ct thỏ hsd
            {
                var timeServer = ServerUtils.CurrentTimeSecond();
                ...
                {
                    Id = 147,
                    Param = (short)ServerUtils.RandomNumber(10, 60),
                });
                itemGift.Options.Add(new OptionItem()
                {
                    Id = 77,
                ...
                {
                    Id = 117,
                    Param = (short)ServerUtils.RandomNumber(15, 20),
                });
            }
            else if (randomPercen < 70.0)// ct thỏ hsd
            {
                var random = new Random();
                int index = random.Next(DataCache.ListSaoPhaLe.Count);
                short idSaoPhaLe = DataCache.ListSaoPhaLe[index];
                itemGift = ItemCache.GetItemDefault(idSaoPhaLe);
                itemGift.Quantity = 5;
            }
            else// vàng
            {
                var gold = ServerUtils.RandomNumber(20000, 10000000);
                var randomRate = ServerUtils.RandomNumber(0.0, 100.0);
                if (randomRate <= 1.0)
                {
                    //1%
            ...
            if (randomPercen >= 70) return;

            character.CharacterHandler.AddItemToBag(false, itemGift, "Nhận từ hộ quà 8/3");
            character.CharacterHandler.SendMessage(Service.SendBag(character));
        }

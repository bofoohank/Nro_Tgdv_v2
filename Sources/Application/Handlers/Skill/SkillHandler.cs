            ...
            try
            {
                ...
                switch (status)
                {
                    ...
                    case 0:
                    {
                        ...
                        if (character.InfoSet.IsFullSetKaioken)
                        {
                            time*=2;
                        }
            ...
            try
            {
                ...
                switch (status)
                {
                    ...
                    case 0:
                    {
                        ...
                        if (disciple.InfoSet.IsFullSetKaioken)
                        {
                            time*=2;
                        }
        ...
        public static void HandlePlayerAttackMonster(ICharacter character, SkillCharacter skillChar, SkillDataTemplate skillDataTemplate, IEnumerable<IMonster> monsters, long damage = 0, bool isCrit = false)  
        {
            ...
            if (damage == 0)
            {
                ...
                if (character.Id > 0)
                {
                    ...
                    else if (skillChar.Id == 17 && character.InfoSet.IsFullSetLienHoan)
                    {
                        damage = damage * 2;
                    }
                    else if (skillChar.Id == 9 && character.InfoSet.IsFullSetKaioken)
                    {
                        damage = damage * 3;
                    }
                }
                ...
                lock (monster)
                {
                    ...
                    if (monster.IsDie)
                    {
						...
						switch(task.Id)
						{
							...
							case 14:
							{
								//if(character.Zone.ZoneHandler.GetCharacterClanInMap(character.ClanId).Count < 3)  //Yêu cầu phải có 2 thành viên

        ...
        public static void HanleInputClient(Model.Character.Character character, Message message)
        {
            ...
            try
            {
                ...
                switch (character.TypeInput)
                {
					...
					//Chẵn lẻ
					case 6:
                        var soThoiVangInputC = listInput[0];
                        CLTX.HandleCuocChan(character, listInput[0]);
                        break;						  
                    case 7:
                        var soThoiVangInputL = listInput[0];
                        CLTX.HandleCuocLe(character, listInput[0]);
                        break;
					//Tài xỉu
					case 8:
					    var soThoiVangInputT = listInput[0];
                        CLTX.HandleCuocTai(character, listInput[0]);
                        break;
					case 9:
					    var soThoiVangInputX = listInput[0];
                        CLTX.HandleCuocXiu(character, listInput[0]);
                        break;

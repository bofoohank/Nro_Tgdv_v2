...
namespace NRO_Server.Application.Constants
{
    public class DataCache
    {
        ...
        public static readonly int GIA_NO_TRUNG_MA_BU = 1100000000;
        #endregion

        #region Giới hạn
        //Mvbt mhbt
        public static readonly int LIMIT_TRAIN_MANH_VO_BONG_TAI_NGAY = 9999;
        public static readonly int LIMIT_TRAIN_MANH_HON_BONG_TAI_NGAY = 396;

        //Slot rương thượng đế
        ...
        public static List<short> LuckBoxEpic = new List<short>() { 342, 343, 344, 345, 18, 19, 20 };
        ...
        //Gọi rồng
        public static List<short> LIMIT_SO_LAN_GOI_RONG = new List<short> { 0, 3 };//tài khoản thường, tài khoản premium

        //Giao dịch
        public static readonly int LIMIT_NOT_PREMIUM_TRADE_DAY = 5;
        public static readonly long LIMIT_NOT_PREMIUM_TRADE_TIME = 600000;
        ...
        //Sức mạnh
        public static readonly int MAX_LIMIT_POWER_LEVEL = 16;
        ...
        #region Map
		public static List<int> IdMapKhongTNSM = new List<int> { 155, 156, 157, 158, 159 };
        ...
        public static List<int> IdMapTapLuyen = new List<int> { 166 };

        public static List<int> IdMapThucVat = new List<int> { 160, 161, 162, 163 };
		
		public static List<int> IdMapNgucTu = new List<int> { 155 };
        ...
        //562 564 566 561
        public static List<short> ListDoThanLinh = new List<short>() { 555, 556, 557, 558, 559, 560, 563, 565, 567, 562, 566, 555, 556, 564, 557, 558, 559, 560, 563, 565, 567 };
        ...
        #region Boss
        public static readonly int BOSS_BROLY_TYPE = 0;
		...
		public static readonly int BOSS_CUMBER_TYPE = 57;
		public static readonly int BOSS_SUPER_CUMBER_TYPE = 58;
        ...
        public static int[][] PercentPhaLe = new int[][]{
            ...
            new int[] {90, 7, 60},// 6s
            new int[] {120, 4, 70},// 7s
            new int[] {180, 4, 140},//8s
            new int[] {190, 1, 140},// 9s
            new int[] {200, 1, 180}// 10s
        };
        ...
        public static readonly short SHOP_ID_NAPTHE = 3000;

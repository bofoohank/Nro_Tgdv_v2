...
namespace NRO_Server.Application.Constants
{
    public class TextServer
    {
        ...
        public readonly string LOCK_LOGIN = "Vui lòng đăng ký tài khoản để vào game";
        public readonly string NOT_ACTIVE = "Tài khoản của bạn chưa được kích hoạt\nTruy cập TGDV để kích hoạt tài khoản với phí chỉ 20k VNĐ bằng cách nạp card.";
        ...
        public readonly string NAP_VANG = "Hãy truy cập web TGDV để xem hướng dẫn nạp thêm VNĐ rồi quay lại đây nhé.";
        ...
        public readonly string NOT_PREMIUM = "Bạn không phải là thành viên chính thức, vui lòng gặp Diễm my ở Đảo kame";
        public readonly string PLAYER_NOT_PREMIUM = "Người chơi đó không phải là thành viên chính thức";
        public readonly string UPGRADE_TO_PREMIUM = "Xin chúc mừng bạn đã là thành viên chính thức của TGDV";
		...
		public readonly string PLEASE_USE_PORATA_4 = "Vui lòng sử dụng Bông Tai Porata Cấp 4";
        ...
        public readonly string NOT_HAVE_ROCK = "Thiếu đá là ta không chịu đâu nha";
		public readonly List<string> TGDV_BOSS_CHAT = new List<string>() { "Ngươi không đánh lại ta đâu. Nạp lần đầu đi...", "Ta khuyên thật đó nạp đi cu.", "Không nạp thì ngươi không có tuổi." };

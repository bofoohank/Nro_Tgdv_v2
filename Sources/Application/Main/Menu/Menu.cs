...
namespace NRO_Server.Application.Main.Menu
{
    public static class Menu
    {
        ...
        public static void OpenUiMenu(short npcId, Character character)
        {
            ...
            try
            {
                switch (npcId)
                {
                    ...
                    case 17:
                        {
                            MenuNTBM.Gi().OpenMenuNTBM(character, npcId, 0);
							break;
                        }
                    #endregion
                    ...
                    case 21:
                        {
                            switch (character.InfoChar.MapId)
                            {
                                ...
                                case 84:
                                    {
                                        character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextBaHatMit[0], MenuNpc.Gi().MenuBaHatMit[1], character.InfoChar.Gender));
                                        character.TypeMenu = 0;
                                        break;
                                    }
                            }
                    ...
                    case 44:
                        {
                            if (character.InfoChar.MapId == 50)
                            {
                            ...
                            if (character.InfoChar.MapId == 154)
                            {
                            ...
                            if (character.InfoChar.MapId == 155)
                            {
                            ...
                            if (character.InfoChar.MapId == 52)
                            {
                                character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, "Ta vừa bí mật đuổi theo 2 tên kia tới đây\n Ngươi muốn vào cùng ta chứ ?", MenuNpc.Gi().MenuOsin[3], character.InfoChar.Gender));
                            }
                            if (character.InfoChar.MapId == 114)
                            {
                                character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, "Ngươi cần gì ?", MenuNpc.Gi().MenuOsin[4], character.InfoChar.Gender));
                            }
                            character.TypeMenu = 0;
                            break;
                        }
					...
					#region Lý tiểu nương - 54
					case 54:
					    {
						    MenuCLTX.Gi().OpenMenuCLTX(character, npcId, 0);
							break;
					    }
					#endregion
                    ...
                    case 71:
                        {
							MenuKhamDa.Gi().OpenMenuKhamDa(character, npcId, 0);
							break;
                        }
                    #endregion
                    ...
                    case 78:
                        {
                            MenuNCBT.Gi().OpenMenuNCBT(character, npcId, 0);
							break;
                        }
                    #endregion
                    ...
                    case 77:
                        {
                            character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextDiemMy[0], MenuNpc.Gi().MenuDiemMy[0], character.InfoChar.Gender));
                            character.TypeMenu = 0;
                            break;
                        }
                    #endregion
                    ...
                    case 80:
                        {
                            MenuNcSKH.Gi().OpenMenuNcSKH(character, npcId, 0);
							break;
                        }
                    #endregion
                    ...
                    case 67:
                        {
                            switch (character.InfoChar.MapId)
                            {
                                case 166:
                                    {
                                        character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextMrpopo[0], MenuNpc.Gi().MenuMrpopo[0], character.InfoChar.Gender));
                                        character.TypeMenu = 0;
                                        break;
                                    }
                            }
        ...
        public static void UiConfirm(Message message, Character character)
        {
            try
            {
                ...
                switch (npcId)
                {
                    ...
                    case 17:
                        {
                            MenuNTBM.Gi().ConfirmMenuNTBM(character, npcId, select);
							break;
                        }
                    case 18:
                        {
                    ...
                    case 54:
                        {
                            MenuCLTX.Gi().ConfirmMenuCLTX(character, npcId, select);
                            break;
                        }
                    case 55:
                        {
                    ...
                    case 67:
                        {
                            ConfirmMrpopo(character, npcId, select);
                            break;
                        }
					case 71:
                        {
                            MenuKhamDa.Gi().ConfirmMenuKhamDa(character, npcId, select);
                            break;
                        }
                    case 77:
                        {
                            ConfirmDiemMy(character, npcId, select);
                            break;
                        }
					case 78:
						{
							MenuNCBT.Gi().ConfirmMenuNCBT(character, npcId, select);
							break;
						}
                    case 79:
                        {
					...
					case 80:
						{
							MenuNcSKH.Gi().ConfirmMenuNcSKH(character, npcId, select);
							break;
						}
                }
            }
                ...
                case 0:
                    {
                        switch (select)
                        {
                            ...
                            case 3://skip nhiệm vụ
                                {
                                    var karin = new Karin();
                                    karin.GetMapById(166)
        ...
        {
            if (character.TypeMenu == 0 && select == 1 && character != null)
            {
                // check hoa
                var item723 = character.ItemBag.FirstOrDefault(item => item.Id == 723);
                if (item723 == null || item723.Quantity < 99)
                {
                    character.CharacterHandler.SendMessage(Service.ServerMessage(TextServer.gI().NOT_ENOUGH_QUANTITY));
                    return;
                }
                ...
                character.CharacterHandler.RemoveItemBagById(item723.Id, 99, "Cường Hóa");
                var gift = ItemCache.GetItemDefault(1109);
                gift.Quantity = 1;
                character.CharacterHandler.AddItemToBag(true, gift, "Đổi hoa");
                character.CharacterHandler.SendMessage(Service.SendBag(character));
                character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, MenuNpc.Gi().TextBumma[2]));
                character.CharacterHandler.SendMeMessage(Service.ServerMessage("Chúc mừng con nhận được x1 hộp quà"));
                return;
            }
                ...
                case 0:
                    {
                        switch (select)
                        {
                            ...
                            case 2:
                                {
                                    character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextQuyLao[4], MenuNpc.Gi().MenuQuyLao[3], character.InfoChar.Gender));
                ...
                case 5:
                    {
                        switch (select)
                        {
                            ...
                            case 1:
                                {
                                    character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextQuyLao[6], MenuNpc.Gi().MenuQuyLao[4], character.InfoChar.Gender));
				...
				case 6:
					{
						...
						else if (character.CharacterHandler.GetItemBagById(457).Quantity < 50)
						{
							character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn không có đủ thỏi vàng"));
						}
						else if(character.InfoChar.Task.Id > 32)
						{
							character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn đã full nhiệm vụ"));
						}
						else
						{
							character.CharacterHandler.RemoveItemBagById(457, 50, reason: "Skip task");
                            character.CharacterHandler.SendMessage(Service.ServerMessage("Bỏ qua nhiệm vụ thành công"));
							character.InfoChar.Task.Index++;
							character.CharacterHandler.SendMessage(Service.SendTask(character));
							character.InfoChar.Task.Count = 0;
                            ...
                            case 0: 
                                {
                                    ...
                                    {
                                        character.CharacterHandler.SendMessage(
                                            Service.ServerMessage("Bạn không có đủ thỏi vàng"));
                                        break;
                                    }

                                    else if (character.CharacterHandler.GetItemBagById(457).Quantity < 10)
                                    {
                                        character.CharacterHandler.SendMessage(
                                            Service.ServerMessage("Bạn không có đủ thỏi vàng"));
                                    }

                                    else if (character.ClanId == -1)
                                    {
                                        character.CharacterHandler.SendMessage(
                                            Service.ServerMessage("Đã có bang đ** đâu :)"));
                                    }
                                    else
                                    {
                                        character.CharacterHandler.RemoveItemBagById(457, 10, reason: "Xóa bang");
                                        character.CharacterHandler.SendMessage(
                                            Service.ServerMessage("Bạn đã rời bang hội thành công\n Hãy thoát ra vô lại để cập nhật"));
        ...
        {
            return type * 5 + " [Đá Hắc hoả] và [Đá Vĩnh hằnng]";
        }
                        ...
                        switch (select)
                        {
                            case 0:
                                ...
                                if (checkOption(character, 0))
                                {
                                    ...
                                    {
                                        CuongHoaTrangBi(character, 0, percenFail, 0);
                                    }
                                    else if (checkAo.Id == 230 || checkAo.Id == 234 || checkAo.Id == 238)
                                    {
                                        CuongHoaTrangBi(character, 1, percenFail + 15, 0);
                                    }
                                    else if (checkAo.Id == 233 || checkAo.Id == 237 || checkAo.Id == 241)
                                    {
                                        CuongHoaTrangBi(character, 2, percenFail + 25, 0);
                                    }
                                    else if (checkAo.Id == 555 || checkAo.Id == 557 || checkAo.Id == 559)
                                    {
                                        CuongHoaTrangBi(character, 3, percenFail + 27, 0);
                                    }
                                    else
                                    {
                            ...
                            case 0:
                                ...
                                else
                                {
                                    if (checkOption(character, 1))
                                    {
                                        ...
                                        if (checkQuan.Id == 6 + character.InfoChar.Gender)
                                        {
                                            CuongHoaTrangBi(character, 0, percenFail, 1);
                                        }
                                        else if (checkQuan.Id == 242 || checkQuan.Id == 246 || checkQuan.Id == 250)
                                        {
                                            CuongHoaTrangBi(character, 1, percenFail + 20, 1);
                                        }
                                        else if (checkQuan.Id == 245 || checkQuan.Id == 249 || checkQuan.Id == 253)
                                        {
                                            CuongHoaTrangBi(character, 2, percenFail + 25, 1);
                                        }
                                        else if (checkQuan.Id == 556 || checkQuan.Id == 558 || checkQuan.Id == 560)
                                        {
                                            CuongHoaTrangBi(character, 3, percenFail + 27, 1);
                                        }
                                        else
                                        {
                                            character.CharacterHandler.SendMeMessage(Service.ServerMessage("Vật phẩm Cường Hóa không hợp lệ!"));
                            ...
                            case 0:
                                ...
                                else
                                {
                                    if (checkOption(character, 2))
                                    {
                                        ...
                                        {
                                            CuongHoaTrangBi(character, 1, percenFail + 20, 2);
                                        }
                                        else if (templateGang.Level == 12)
                                        {
                                            CuongHoaTrangBi(character, 2, percenFail + 25, 3);
                                        }
                                        else if (templateGang.Level == 13)
                                        {
                                            CuongHoaTrangBi(character, 3, percenFail + 27, 4);
                                        }
                                        else
                                        {
                                            character.CharacterHandler.SendMeMessage(Service.ServerMessage("Vật phẩm Cường Hóa không hợp lệ!"));
                            ...
                            case 0:
                                ...
                                else
                                {
                                    if (checkOption(character, 3))
                                    {
                                        ...
                                        if (checkGiay.Id == 27 + character.InfoChar.Gender)
                                        {
                                            CuongHoaTrangBi(character, 0, percenFail, 3);
                                        }

                                        else if (templateGiay.Level == 9)
                                        {
                                            CuongHoaTrangBi(character, 1, percenFail + 15, 3);
                                        }
                                        else if (templateGiay.Level == 12)
                                        {
                                            CuongHoaTrangBi(character, 2, percenFail + 20, 3);
                                        }
                                        else if (templateGiay.Level == 13)
                                        {
                                            CuongHoaTrangBi(character, 3, percenFail + 25, 3);
                                        }
                                        else
                                        {
                                            character.CharacterHandler.SendMeMessage(Service.ServerMessage("Vật phẩm Cường Hóa không hợp lệ!"));
                            ...
                            case 0:
                                ...
                                else
                                {
                                    if (checkOption(character, 4))
                                    {
                                        ...
                                        if (checkRada.Id == 12)
                                        {
                                            CuongHoaTrangBi(character, 0, percenFail + 5, 4);
                                        }
                                        else if (templateRada.Level == 9)
                                        {
                                            CuongHoaTrangBi(character, 1, percenFail + 7, 4);
                                        }
                                        else if (templateRada.Level == 12)
                                        {
                                            CuongHoaTrangBi(character, 2, percenFail + 10, 4);
                                        }
                                        else if (templateRada.Level == 13)
                                        {
                                            CuongHoaTrangBi(character, 3, percenFail + 12, 4);
                                        }
                                        else
                                        {
                                            character.CharacterHandler.SendMeMessage(Service.ServerMessage("Vật phẩm Cường Hóa không hợp lệ!"));
        ...
        public static void CuongHoaTrangBi(Character character, int set, int percenSuccess, int type)
        {
            int totalRockForUpdate = 5 * (set + 2);
            for (int dball = 1093; dball <= 1094; dball++)
            {
                if (character.CharacterHandler.GetItemBagById(dball) == null || character.CharacterHandler.GetItemBagById(dball).Quantity < totalRockForUpdate)
                {
                    character.CharacterHandler.SendMessage(Service.ServerMessage(TextServer.gI().NOT_HAVE_ROCK));
                    return;
                }
            }
            for (short dball = 1093; dball <= 1094; dball++)
            {
                ...
                character.CharacterHandler.RemoveItemBagById(dball, totalRockForUpdate, "Cường Hóa");
            }
            var itemCuongHoa = ItemCache.GetItemDefault(1);
            var itemTemplate = ItemCache.ItemTemplate(itemCuongHoa.Id);
            switch (set)
            {
                #region case 0 level 1
                case 0:
                    {
                        switch (type)
                        {
            ...
            if (character.InfoChar.Gender == 0)
            {
                ...
                else if (randomChiS <= 80)// set kaioken
                {
            ...
            else if (character.InfoChar.Gender == 1)
            {
                ...
                else if (randomChiS <= 80)//set liên hoàn
                {
                    itemCuongHoa.Options.Add(new OptionItem()
                    {
                        Id = 131,
            ...
            else if (character.InfoChar.Gender == 2)
            {
                ...
                else if (randomChiS <= 80)//set cadic
                {
                    itemCuongHoa.Options.Add(new OptionItem()
                    {
                        Id = 134,
            ...
            if (randomChiS < percenSuccess - 10)
            {
                character.CharacterHandler.SendMeMessage(Service.ServerMessage("Đen thôi đỏ vẫn thế."));
                character.CharacterHandler.SendMessage(Service.SendBag(character));
            }
            else
            {
                character.CharacterHandler.RemoveItemBody(type);
                ...
                case 0:
                    {
                        ...
                        {
                            character.CharacterHandler.SendMessage(Service.OpenUiSay(5, "Bạn cần đạt 180 tỷ sức mạnh mới có thể đến khu vực này", false, character.InfoChar.Gender));
                            return;
                        }
                        if (character.InfoChar.Task.Id < 31)
                        {
        ...
        private static void ConfirmDiemMy(Character character, short npcId, int select)
        {
            switch (character.TypeMenu)
            {
                case 0:
                    {
                        switch (select)
                        {
                            case 0:
                                {
                                    character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, string.Format(MenuNpc.Gi().TextDiemMy[2], ServerUtils.GetMoneys(UserDB.GetVND(character.Player)), ServerUtils.GetMoneys(UserDB.GetTongVND(character.Player))), MenuNpc.Gi().MenuDiemMy[2], character.InfoChar.Gender));
                                    character.TypeMenu = 1;
                                    break;
                                }
                ...
                case 1:
                    {
                        switch (select)
                        {
                            case 0:
                                ...
                                /// doi vang + ngoc 
                                character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, string.Format(MenuNpc.Gi().TextDiemMy[5], ServerUtils.GetMoneys(UserDB.GetVND(character.Player))), MenuNpc.Gi().MenuDiemMy[3], character.InfoChar.Gender));
                                character.TypeMenu = 2;
                                break;
                            case 1:
                                // kich hoat thanh vien
                                character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, string.Format(MenuNpc.Gi().TextDiemMy[4], ServerUtils.GetMoneys(UserDB.GetVND(character.Player))), MenuNpc.Gi().MenuDiemMy[6], character.InfoChar.Gender));
                                character.TypeMenu = 5;

                                break;
                            case 2:
                                //de tu vip
                                character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, string.Format(MenuNpc.Gi().TextDiemMy[6], ServerUtils.GetMoneys(UserDB.GetVND(character.Player))), MenuNpc.Gi().MenuDiemMy[7], character.InfoChar.Gender));
                                character.TypeMenu = 6;
                            ...
                            case 1:
                                {
                                    ...
                                    {
                                        character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, string.Format(MenuNpc.Gi().TextDiemMy[3] + "\n|1|Tình Trạng Khuyến Mãi [Không có Khuyến Mãi]", ServerUtils.GetMoneys(UserDB.GetVND(character.Player))), MenuNpc.Gi().MenuDiemMy[4 + select], character.InfoChar.Gender));
                                        character.TypeMenu = 3 + select;
                                        break;
                                    }
                                    else
                                    {
                                        character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, string.Format(MenuNpc.Gi().TextDiemMy[3] + "\n|1|TÌnh Trạng Khuyến Mãi [Đang X" + DatabaseManager.Manager.gI().costDoiTien + "]", ServerUtils.GetMoneys(UserDB.GetVND(character.Player))), MenuNpc.Gi().MenuDiemMy[4 + select], character.InfoChar.Gender));
                                        character.TypeMenu = 3 + select;
                                        break;
                                    }
                                }
                        ...
                        case 0:
                            {
                                ...
                                itemAddd.Quantity = 1;
                                character.CharacterHandler.AddItemToBag(true, itemAddd, "Đổi đá sắc màu");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                UserDB.MineVND(character.Player, 20000);
                                character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn nhận được 1 Đá sắc màu!"));
                                break;
                            }
                    }
                    break;
        ...
        private static void ConfirmMrpopo(Character character, short npcId, int select)
        {
            switch (character.TypeMenu)
            {
                case 0:
                                ...
                                case 0:
                                    {
                                        switch (character.InfoChar.Gender)
                                        {
                                            ...
                                            case 1:
                                                {
                                                    mapJoin = MapManager.Get(7);
                                                    break;
                                                }
                                            case 2:
                                                {
                                                    mapJoin = MapManager.Get(14);
                                                    break;
                                                }
                                        }
                                        break;
                ...
                case 0:
                    {
                        switch (select)
                        {
                            case 0:
                                ...
                                if (character.InfoChar.MapId == 155)
                                {
                                    mapJoin = MapManager.Get(154);
                                }
                                if (character.InfoChar.MapId == 52)
                                {
                                    var chars = (Model.Character.Character)character;
                                    mapJoin = MapManager.Get(114);
                                }
								if (character.InfoChar.MapId == 154)
								{
